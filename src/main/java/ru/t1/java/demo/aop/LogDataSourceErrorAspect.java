...
public class LogDataSourceErrorAspect {
    ...
    public void logError(JoinPoint joinPoint, Throwable ex) {
        ...
        try {
             kafkaProducerService.sendMessage(logDataSourceProperty.getLogErrorTopic(), "errorType",
                    logDataSourceProperty.getLogErrorHeader(), dataSourceErrorLogDto)
                    .get(logDataSourceProperty.getTimeOut(), SECONDS);
            log.info("Message successfully sent to Kafka topic {}:", logDataSourceProperty.getLogErrorTopic());
